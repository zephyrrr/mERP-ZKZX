...
{
    public partial class 专家调度一级动态优化进口箱带货 : Feng.Windows.Forms.MyTemplateForm, IRefreshDataForm
    {
        #region "Constructor"
        public 专家调度一级动态优化进口箱带货()
        {
            InitializeComponent();
        }
        ...
        {
            m_topGrid = base.AssociateBoundGrid(pnl任务集合top, "专家级调度_一级动态优化_动态进口箱带货_任务集合top") as DataUnboundGrid;
        ...
        #region "Auto"
        private 专家任务性质 m_hereZjrwxz = 专家任务性质.动态优化进口箱带货;
