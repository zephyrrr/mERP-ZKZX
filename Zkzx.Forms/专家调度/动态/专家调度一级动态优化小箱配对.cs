...
{
    public partial class 专家调度一级动态优化小箱配对 : Feng.Windows.Forms.MyTemplateForm, IRefreshDataForm
    {
        #region "Constructor"
        public 专家调度一级动态优化小箱配对()
        {
            InitializeComponent();
        }
        ...
        private void btn计算机辅助优化_Click(object sender, EventArgs e)
        {
            if (m_lastGrid == m_topGrid)
                专家调度一级静态优化.选择组合(m_topGrid, m_bottomGrid, new List<专家任务性质> { 专家任务性质.动态优化进口箱对箱, 专家任务性质.动态优化出口箱对箱, 专家任务性质.动态优化进出口对箱 });
            else
                专家调度一级静态优化.选择组合(m_bottomGrid, m_topGrid, new List<专家任务性质> { 专家任务性质.动态优化进口箱对箱, 专家任务性质.动态优化出口箱对箱, 专家任务性质.动态优化进出口对箱 });
        }
        ...
        {
            专家调度一级静态优化.自动优化(m_topGrid, m_bottomGrid, new List<专家任务性质> { 专家任务性质.动态优化进口箱对箱, 专家任务性质.动态优化出口箱对箱, 专家任务性质.动态优化进出口对箱 });
        }
        #endregion
